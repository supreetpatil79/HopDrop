            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-bold text-zinc-950">HopDrop Sender</p>
                    <p className="text-[10px] text-zinc-400">Intercity Parcel Network</p>
                  </div>
                </div>
                <button
                  type="button"
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between rounded-xl bg-zinc-50 p-2.5">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <p className="text-xs font-bold text-zinc-900">{user?.name || 'Sender'}</p>
                        <p className="text-[10px] text-zinc-400">₹{(user?.wallet?.balance || 0).toLocaleString('en-IN')} balance</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    >
                      <PackageCheck className="h-3.5 w-3.5 mr-1.5 text-zinc-500" />
                      Profile
                    </Button>
                  </div>
