...
export default function LoginPage() {
  ...
  const sendOtpMutation = useMutation({
    ...
    onSuccess: () => {
      trackFunnelStep('carrier_activation', 'login_otp_requested');
      toast.success('OTP sent successfully');
    },
    onError: (error) => {
      captureClientError(error, { source: 'carrier_login_send_otp' });
    }
  });
  ...
  const loginMutation = useMutation({
    ...
    onError: (error) => {
      captureClientError(error, { source: 'carrier_login_submit' });
    }
  });
